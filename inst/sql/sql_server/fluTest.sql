...
WHERE (C.visit_start_date >= DATEFROMPARTS(2017, 9, 1) and C.visit_start_date <= DATEFROMPARTS(2018, 4, 1))
...
WHERE C.value_as_concept_id in (4126681,9191,3475508,45879438,4181412,45877985,45884084)
...
WHERE C.value_as_concept_id in (4126681,3475508,45877985,9191,45884084,45879438,4181412)
